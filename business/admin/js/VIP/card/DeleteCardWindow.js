Ext.define('VIP.card.DeleteCardWindow', {
	extend : 'Ext.window.Window',
	alias : [ 'widget.deletecardwindow' ],
		...
		var items = [ {
			...
			items : [ {
				...
				items : [ {
					xtype : 'label',
					fieldLabel : '类别名称',
					text: "该会员等级下,共拥有会员"+me.params.count+"人,请将他们转移至其他会员等级",
					padding:'10 10 10 20'
				},{
					xtype : 'vcombo',
					...
					getProxy : function() {
						return {
							type : 'direct',
							directFn : 'CardTypeAction.getRestCardTypeOptions',
							reader : {
								type : 'json',
								root : 'records'
							},
							extraParams : {
								cardTypeId: me.params.cardTypeId,
